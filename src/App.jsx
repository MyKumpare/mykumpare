...
import FirmAumSummary from './pages/FirmAumSummary';
...
const AuthenticatedApp = () => {
  ...
  return (
    ...
    <Routes>
      ...
      <Route path="/ComplianceRenewalDashboard" element={<LayoutWrapper currentPageName="ComplianceRenewalDashboard"><ComplianceRenewalDashboard /></LayoutWrapper>} />
      ...
      <Route path="/FirmAumSummary" element={<LayoutWrapper currentPageName="FirmAumSummary"><FirmAumSummary /></LayoutWrapper>} />
