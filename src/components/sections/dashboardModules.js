...
export const DASHBOARD_MODULES = [
  ...
  { key: "firm-aum-summary", label: "Firm AUM Summary", icon: TrendingUp, color: "text-emerald-600", bg: "bg-emerald-50", border: "border-emerald-200", to: "/FirmAumSummary" },
...
export const DASHBOARD_DEFAULT_CATEGORIES = [
  ...
  { id: "trends", name: "Trends", items: ["aum-trends", "firm-aum-summary", "firm-category", "database-growth", "recently-added-firms"] },
