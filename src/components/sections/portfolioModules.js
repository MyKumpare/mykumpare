import { Briefcase, Wallet, BarChart3, Scale, Bell } from "lucide-react";
...
export const PORTFOLIO_MODULES = [
  ...
  { key: "funding-status-alerts", label: "Funding Status Alerts", icon: Bell, color: "text-amber-600", bg: "bg-amber-50", border: "border-amber-200" },
...
export const PORTFOLIO_DEFAULT_CATEGORIES = [
  ...
  { id: "oversight", name: "Oversight", items: ["reconciliation-alerts", "funding-status-alerts"] },
