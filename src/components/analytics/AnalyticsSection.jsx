                  ...
                  {filtered.length === 0 ? (
                    ...
                    filtered.map((p) => {
                      ...
                      return (
                        ...
                        >
                          <div
                            className={`w-4 h-4 rounded border flex items-center justify-center flex-shrink-0 ${checked ? "bg-cyan-600 border-cyan-600" : "border-gray-300"}`}
                          >
                            {checked && (
                              <svg
                                viewBox="0 0 10 8"
                          ...
                          <div className="min-w-0">
                            ...
                            {p.firm_name && (
                              <p className="text-gray-400 truncate">{p.firm_name}</p>
                            )}
                          </div>
                        </button>
                      );
