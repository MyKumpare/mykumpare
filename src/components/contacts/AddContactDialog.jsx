...
import { X, Plus, Building2, Pencil, Trash2, User, Phone, MapPin, Upload } from "lucide-react";
        ...
        <div className="overflow-y-auto flex-1 py-2 pr-1">
          <Tabs defaultValue="info">
            ...
            <TabsContent value="addresses" className="space-y-3 mt-0">
              ...
              {!viewMode && (
                <Button type="button" variant="outline" size="sm" className="w-full h-8 text-xs gap-1 text-indigo-600 border-indigo-200 hover:bg-indigo-50" onClick={addAddress}>
